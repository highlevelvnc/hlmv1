...
export default function Header() {
  ...
  useEffect(() => {
    const onScroll = () => {
      ...
      // Only reveal header after user scrolls past the funnel intro (~40% of viewport)
      // Stay hidden during the entire funnel journey — reveal when exiting
      setRevealed(window.scrollY > window.innerHeight * 2.8);
    };
